...
<div class="modal-footer row display py-1">
		<div class="col-lg-12">
			<button class="btn float-right btn-secondary" type="button" data-dismiss="modal" style="font-family: B Koodak;">بستن</button>
			<button class="btn float-right btn-success mr-2" type="button" id="print" style="font-family: B Koodak;">ذخیره و چاپ</button>
		</div>
</div>
<style>
